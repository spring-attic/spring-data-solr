...
public class SimpleSolrPersistentEntityTest {
  ...
  public void testPersistentEntityWithSolrDocumentAnnotation() {
    ...
    SimpleSolrPersistentEntity<SearchableBeanWithSolrDocumentAnnotation> pe = new SimpleSolrPersistentEntity<SearchableBeanWithSolrDocumentAnnotation>(typeInfo);
  ...
  public void testPersistentEntityWithoutSolrDocumentAnnotation() {
    ...
    SimpleSolrPersistentEntity<SearchableBeanWithoutSolrDocumentAnnotation> pe = new SimpleSolrPersistentEntity<SearchableBeanWithoutSolrDocumentAnnotation>(typeInfo);
  ...
  public void testPersistentEntityWithEmptySolrDocumentAnnotation() {
    ...
    SimpleSolrPersistentEntity<SearchableBeanWithEmptySolrDocumentAnnotation> pe = new SimpleSolrPersistentEntity<SearchableBeanWithEmptySolrDocumentAnnotation>(typeInfo);
