...
[WARNING]
====
**This project is about to move to the https://github.com/spring-attic/[Spring Attic] and is not recommended for new projects. +
The last Release (4.3.0) will, as part of the spring data release 2020.0, see patch updates till mid 2022.**
====
